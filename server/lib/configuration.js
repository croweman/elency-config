class Configuration
{
  constructor(config) {
    ...
    this.runOverHttp = (process.env.ELENCY_CONFIG_RUN_OVER_HTTP === 'true' || process.env.ELENCY_CONFIG_RUN_OVER_HTTP === true || config.runOverHttp === 'true' || config.runOverHttp === true);
